...
import { ScrollPositionEffectProps, useScrollPosition } from 'src/hooks/useScrollPosition';
import { NavItems, SingleNavItem } from 'src/types';
...
function NavItem({ href, title, outlined }: SingleNavItem) {
  ...
  if (outlined) {
    return <CustomButton onClick={() => {}}>{title}</CustomButton>;
  }
